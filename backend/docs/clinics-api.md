...
- PDF بقالب DirectoryReport المشترك وmPDF مع Cairo Regular وBold ثابتين TTF مضمنين وOTL للعربية، دون fallback أو اتصال خارجي. يحتفظ frontend بخط Cairo المحلي. الشعار140px مشتق من أصل الهوية، وزخرفة محلية خافتة في الترويسة. النصوص تُهرب في Blade. الجدول يكرر thead، والتقرير المفرد يحمل كامل التوصيف والأطباء دون أي أسماء مرضى.
...
- النصوص الطويلة في القوائم تحيل صراحةً إلى ملحق PDF كامل أو ورقة XLSX «النصوص الكاملة» المرتبة، والتفاصيل تتدفق عبر الصفحات. أُلغي رفض PDF_LAYOUT_LIMIT_EXCEEDED الخاص بطول الخلية؛ لا قص صامت أو تصغير شامل.
