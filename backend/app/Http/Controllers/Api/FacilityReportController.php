...
class FacilityReportController extends Controller
{
    ...
    {
        $f = $this->reports->facility($request->user(), $request->integer('facility_id'));
        if (! in_array('reports.export', $f['permissions'], true)) {
