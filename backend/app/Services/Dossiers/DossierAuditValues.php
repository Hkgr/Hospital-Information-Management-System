...
class DossierAuditValues
{
    private const FIELDS = [
        ...
        'is_oncology' => 'ملف ورمي', 'disability_text' => 'معلومات الإعاقة', 'clinical_history' => 'القصة المرضية', 'weight_kg' => 'الوزن (كغ)', 'height_cm' => 'الطول (سم)',
    ...
    private const GROUPS = [
        ...
        'visit_prescriptions' => ['kind', 'prescribing_clinic_id', 'prescribing_staff_id', 'prescribed_on', 'funding_source_id', 'unavailable_reason'],
    ...
    private const REFERENCES = ['governorate_id' => ['governorates', 'name_ar'], 'city_id' => ['cities', 'name_ar'],
        ...
        'clinic_id' => ['clinics', 'name_ar'], 'prescribing_clinic_id' => ['clinics', 'name_ar'], 'protocol_clinic_id' => ['clinics', 'name_ar'], 'treating_clinic_id' => ['clinics', 'name_ar'],
        'attending_staff_id' => ['staff', 'full_name'], 'diagnosing_staff_id' => ['staff', 'full_name'], 'performed_by' => ['staff', 'full_name'], 'specialist_id' => ['staff', 'full_name'], 'prescribing_staff_id' => ['staff', 'full_name'], 'decided_by' => ['staff', 'full_name'], 'protocol_doctor_id' => ['staff', 'full_name'], 'treating_doctor_id' => ['staff', 'full_name'], 'nurse_id' => ['staff', 'full_name']];
    ...
    private function value(string $field, mixed $value): string
    {
        ...
        $enums = ['status' => ['draft' => 'مسودة', 'active' => 'فعالة', 'complete' => 'مكتملة', 'void' => 'ملغاة', 'voided' => 'ملغاة'],
            ...
            'dossier_visit_kind' => ['initial' => 'أول زيارة مسجلة ضمن البطاقة', 'subsequent' => 'لاحقة'], 'kind' => ['unlinked' => 'أدوية مصروفة من المشفى (غير مرتبطة بالجرعة)', 'dose_linked' => 'أدوية مرتبطة بالجرعة', 'outside' => 'أدوية خارج المشفى'], 'state' => ['pending' => 'قيد الرفع', 'complete' => 'مكتمل', 'cancelled' => 'ملغى'],
