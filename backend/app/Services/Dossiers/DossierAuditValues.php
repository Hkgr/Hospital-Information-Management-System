...
class DossierAuditValues
{
    ...
    private const REFERENCES = ['governorate_id' => ['governorates', 'name_ar'], 'city_id' => ['cities', 'name_ar'],
        ...
        'attending_staff_id' => ['staff', 'full_name'], 'diagnosing_staff_id' => ['staff', 'full_name'], 'performed_by' => ['staff', 'full_name'], 'specialist_id' => ['staff', 'full_name'], 'prescribing_staff_id' => ['staff', 'full_name'], 'decided_by' => ['staff', 'full_name'], 'protocol_doctor_id' => ['staff', 'full_name'], 'treating_doctor_id' => ['staff', 'full_name']];
