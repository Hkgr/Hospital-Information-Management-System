...
class ClinicAudit
{
    public function record(Request $request, int $facilityId, int $clinicId, string $event, ?array $old, ?array $new, string $entityType = 'clinic'): void
    {
        DB::table('audit_logs')->insert([
            'facility_id' => $facilityId, 'actor_id' => $request->user()->id,
            'entity_type' => $entityType, 'entity_id' => $clinicId, 'event' => $event,
