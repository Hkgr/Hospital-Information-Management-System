...
class DirectoryReferences
{
    ...
    public const CLINIC = ['visit_diagnoses' => ['clinic_id'], 'visits' => ['clinic_id'], 'staff_work_days' => ['clinic_id'], 'report_metric_catalog_items' => ['clinic_id'], 'blood_donors' => ['clinic_id'], 'blood_recipients' => ['clinic_id'], 'blood_bank_events' => ['clinic_id']];
