...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('medication_batches', function (Blueprint $t) {
            ...
            $t->foreignId('funding_source_id')->constrained('funding_sources')->restrictOnDelete()->restrictOnUpdate();
        ...
        DB::statement("ALTER TABLE medication_batches ADD CONSTRAINT med_batches_status_values CHECK (status IN ('active','depleted','expired','quarantined')), ADD CONSTRAINT med_batches_received_qty CHECK (received_quantity > 0), ADD CONSTRAINT med_batches_unit_cost CHECK (unit_cost IS NULL OR unit_cost >= 0)");
        ...
        DB::statement('ALTER TABLE stock_issues ADD CONSTRAINT stock_issues_qty CHECK (quantity > 0 AND issued_quantity >= 0 AND shortfall_quantity >= 0 AND issued_quantity + shortfall_quantity = quantity)');
