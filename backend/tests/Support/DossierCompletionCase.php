...
abstract class DossierCompletionCase extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->s = $this->callApi('POST', '', ['person_mode' => 'new', 'code' => 'PH3-'.Str::random(8), 'opening_date' => '2001-01-01', 'visit_date' => '2001-03-02', 'first_name' => 'أحمد', 'family_name' => 'محمد', 'birth_date_accuracy' => 'unknown', 'gender' => 'unknown', 'displacement_status' => 'unknown'])->assertCreated()->json('data');
    ...
    {
        return $extra + ['visit_date' => '2001-03-02', 'is_referred' => false, 'diagnoses' => [['diagnosis_id' => $this->f['diagnosis'], 'diagnosed_on' => null, 'clinic_id' => $this->f['clinics'][0], 'diagnosing_staff_id' => $this->f['workflow_doctors'][0]]]];
    }
