...
export default function FinalReview({facility,snapshot:s,caps,onSaved,onPending,blocked,dirty,reviewed,setReviewed,error,onError,onReviewMode}:{facility:number;snapshot:Snapshot;caps:Record<string,boolean>;onSaved:(s:Snapshot)=>void;onPending:(v:boolean)=>void;blocked:boolean;dirty:boolean;reviewed:boolean;setReviewed:(v:boolean)=>void;error:(key:string)=>React.ReactNode;onError:(e:AuthError)=>void;onReviewMode:(v:boolean)=>void}){
