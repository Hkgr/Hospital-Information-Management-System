...
const steps = ["البيانات الشخصية", "المعلومات الطبية والورمية", "الزيارة والتشخيصات", "الخدمات والإجراءات", "الأدوية والنتيجة", "المرفقات والمراجعة", "التقييم والتشريح المرضي", "الخطة ومواعيد العلاج", "الإعطاء والصرف الفعلي"];
