...
export type DossierRow = { pathology_status: string; pathology_visit_id: number | null; mother_name: string | null; gender: string; birth_date: string | null; birth_date_accuracy: string; phone: string | null; paper_file_number: string | null; card_id: number; legacy_without_visits: boolean; latest_visit_date: string | null; procedure_count: number; workflow: WorkflowActions; status: DossierStatus; latest_visit_status: VisitStatus | null; id: number; code: string; opening_date: string; patient_code: string; patient_name: string; is_oncology: boolean; visit_count: number; latest_visit_id: number | null; diagnoses: Diagnosis[] };
...
export type Visit = { diagnostic_assessment?: import("./pathology").Assessment | null; clinical?: import("./clinical").ClinicalData; is_referred?: boolean | number; referring_hospital?: string | null; referral_date?: string | null; referral_reason?: string | null; status: VisitStatus; id: number; visit_no: string; visit_date: string; visit_clinic: string | null; attending_doctor: string | null; diagnoses: Diagnosis[]; services: ClinicalItem[]; procedures: ClinicalItem[]; outcomes: ClinicalItem[]; medications: ClinicalItem[]; administered_medications: ClinicalItem[] };
