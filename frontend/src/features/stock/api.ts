...
export type Receipt = { id: number; facility_id: number; store_id: number; store_name_ar: string | null; receipt_no: string; supplier_id: number | null; supplier_name_ar: string | null; medication_source: string; funding_name_ar: string | null; received_on: string; invoice_number: string | null; status: "draft" | "confirmed" | "cancelled"; note: string | null; confirmed_at: string | null; lock_version: number; items?: ReceiptItem[] };
export type Choice = { id: number; code: string; name_ar: string };
export type MedicationSource = { code: string; name_ar: string };
export type Options = { stores: Choice[]; suppliers: Choice[]; medications: Choice[]; medication_sources: MedicationSource[] };
