...
export default function Picker({ label, path, choices, eventChoices = false, loading, error, retry, emptyMessage = "لا توجد خيارات مطابقة متاحة.", selected, onSelect }: { label: string; path?: string; choices?: Choice[]; eventChoices?: boolean; loading?: boolean; error?: string; retry?: () => void; emptyMessage?: string; selected?: Choice | null; onSelect: (row: Choice) => void }) {
