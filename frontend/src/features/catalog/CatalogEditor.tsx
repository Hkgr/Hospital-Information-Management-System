...
export default function CatalogEditor({ kind, item, facilityId, onClose, onSaved, onRefresh }: { kind: Kind; item?: Item; facilityId: number; onClose: () => void; onSaved: () => void; onRefresh: () => void }) {
  ...
  const choices = useCatalogRequest<Choices>(`service-catalog/classifications?facility_id=${facilityId}`);
