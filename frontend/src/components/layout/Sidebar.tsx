...
type Props = { pathname: string; granted: string[]; collapsed?: boolean; onToggle?: () => void; onNavigate?: () => void; mobile?: boolean };

export function SidebarContent({ pathname, granted, collapsed = false, onToggle, onNavigate, mobile = false }: Props) {
  return <>
