...
تحديث PR #21: [لقطات تصحيحات العدّاد والصلاحيات والتعارض وتاريخ الزيارة](review-fixes/README.md). أُعيد التقاط اختيار المريض الموجود أدناه بعد الإصلاح؛ الصور الأخرى توثّق المرحلة الثانية قبل هذا التحديث.
