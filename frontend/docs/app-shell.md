...
- اللوحة العامة تعرض اسم المستخدم ومنشآته وإحصاءات مأذون بها (عدادات، أعمدة، دوائر، جداول نشاط، مواعيد قادمة، إجراءات سريعة).
  الكتل الفارغة تبقى مخفية أو برسالة واضحة عند غياب الصلاحية. الحساب بلا منشآت يرى حالة فارغة واضحة. لا قائمة تبديل عند توفر لوحة واحدة.
...
- التنقل الحالي: الرئيسية، بطاقة المريض، الزيارات، الأطباء، العيادات، الخدمات والإجراءات، الأدوية، المخزون، بنك الدم، تقارير، السجل.
  الرئيسية تفتح `/dashboard/general` بإحصاءات مصرّح بها. بطاقة المريض هي مسار إدارة المريض نفسه؛ لا عنصر مرضى موازٍ. الأقسام المنفذة تظهر وفق صلاحياتها،
  السجل يفتح `/audit` كجدول حركات مع شارات للنوع والإجراء والتصنيف. النقر على الصف يفتح `/audit/{id}` لتفاصيل الحركة بما فيها الأخطاء التقنية. تبقى تقارير معطلة مع «قريبًا» ووصف وصول؛
