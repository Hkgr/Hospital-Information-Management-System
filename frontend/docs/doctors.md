...
**تحديث مراجعة PR #9:** أُصلح جلب الارتباطات عند التعارض بمعرّفات ثابتة ودفعات100 للطرفين، مع الهوية الحالية وإلغاء الطلبات والحفظ الصريح. أُعيد تصميم PDF وExcel ومراجعتهما فعليًا. [نتائج هذا الإصلاح وصور قبل/بعد والعينات الجديدة](../../backend/docs/directory-review.md). جداول التنفيذ الأصلي والمسار الحي أدناه تاريخية تخص `af636d5`، ولا تعني إعادة تشغيل المسار الحي في هذه المراجعة.
...
## نتائج التنفيذ الأصلي عند af636d5 (تاريخية)
